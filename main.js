...
const translations = {
    en: {
        ...
        feature6Title: "AI Medicine Info",
        ...
        aboutText: "Built for Bangladesh — We created MEDCUE to solve the confusion and medication mismanagement people face every day. Especially for the elderly and chronic patients, our goal is to provide a reliable, easy-to-use solution that brings peace of mind and better health outcomes.",
    ...
    bn: { // Bengali translations (example, fill with actual translations)
        ...
        aboutText: "বাংলাদেশের জন্য তৈরি — আমরা মেডকিউ তৈরি করেছি প্রতিদিন মানুষ যে বিভ্রান্তি এবং ঔষধের ভুল ব্যবস্থাপনার মুখোমুখি হয় তা সমাধান করতে। বিশেষ করে বয়স্ক এবং দীর্ঘস্থায়ী রোগীদের জন্য, আমাদের লক্ষ্য হল একটি নির্ভরযোগ্য, সহজে ব্যবহারযোগ্য সমাধান প্রদান করা যা মানসিক শান্তি এবং উন্নত স্বাস্থ্য ফলাফল নিয়ে আসে।",
